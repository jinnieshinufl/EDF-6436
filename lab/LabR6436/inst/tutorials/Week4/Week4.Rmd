...
response$'total_score' = rowSums(response)
print(response)
```
...
response$'cr_total_score' = response$'total_score' - response$i10
print(response)
```
...
mx = colMeans(response['cr_total_score'])
mx
...
t_sample= subset(response, response$i10==1) # we will use the function called "subset"
                                            # this function takes in the dataframe first, and the logic to parse the data 
mt = colMeans(t_sample['cr_total_score'])
mt
...
sd_x = sd(response$cr_total_score)
