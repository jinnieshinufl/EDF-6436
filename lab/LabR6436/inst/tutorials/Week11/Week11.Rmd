...
question("which of the following statement is true? (Select all)",
         ...
         answer("We might need to revmove the outliers ", correct=TRUE),
...
```{r, cfa1, exercise=TRUE, echo=FALSE}
...
```{r cfa1-result, exercise=TRUE, echo=FALSE}
summary(cfa_fit1, 
        fit.measures = TRUE, 
        standardized = TRUE, 
        rsquare      = TRUE)
...
```{r, cfa1-fit, exercise=TRUE, echo=TRUE}
...
```{r, modin1, exercise=TRUE, echo=FALSE}
...
```{r compare, exercise=TRUE, echo=FALSE}
...
```{r cfa-sd-all, exercise=TRUE, echo=FALSE}
...
```{r, cfa-plot2, exercise=TRUE, echo=FALSE}
...
```{r, fscore, exercise=TRUE, echo=FALSE}
...
### Let's comapre 
```{r, omega-new, exercise=TRUE, echo=FALSE}
library("semTools")
